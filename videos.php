      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li><a class="current" href="videos.php">Videos</a></li>
    ...
    <section id="main-content">
      <div class="container">
        ...
        <aside>
          <div class="dark">
            <h3>We are trash</h3>
            <p>Do not let us thrugh out the trash or we will kil everyone. asldasdfasdasd asdfa.sdfasdfasd.fa  das sdf as as dasdasd sdf asdasdfa sdasd.fasd asdfjsdlsdkfajd sd alsdasdjlksdfjeioeafdkznf dfa sdfs. d fsfeo aseoaf sdl;aksdf e as.</p>
          </div>
        </aside>
